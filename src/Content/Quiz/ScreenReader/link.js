    ...
    {answer === "no" ? (
      <p>
        ...
        <a
          ...
          href="https://www.accessible-social.com/copy-and-formatting"
        >
        ...
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://uxdesign.cc/just-not-my-type-bb33eb8183c7"
        >
...
export const FacebookExamples = ({ answer }) => (
  <>
    {answer === "yes" ? (
      <>
        <p>
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.facebook.com/EMCosmetics/photos/a.4226438437369108/5718316878181249"
          >
            the one below by EM Cosmetics.
          </a>{" "}
          Using emojis as break lines are not effective and reading this through
          the screenreader will reveal that.
        </p>
        <ImgContainer>
          <SocialMediaExample img={FacebookBE1} alt="" />
        </ImgContainer>
        <p>
          Also, you should avoid using special fonts that can be occasionally
          seen on Facebook. The “funky” font seen in the post below will not be
          read smoothly if you use a screenreader or a TTS program.
        </p>
        <ImgContainer>
          <SocialMediaExample img={FacebookBE2} alt="" />
        </ImgContainer>
      </>
    ) : (
      <>
        <p>
          What we’re trying to avoid are posts that uses an excessive amount of
          emojis and posts with special fonts, as shown below. For example, the
          post on the right won’t read as “Come and celebrate now,” it'll read
          "mathematical symbol italics bold c, mathematical symbol italics bold
          o..." and so on. Not exactly easy to understand.
        </p>
        <TwoEqualColumns>
          <SocialMediaExample img={FacebookBE1} alt="" />

          <SocialMediaExample img={FacebookBE2} />
        </TwoEqualColumns>
      </>
    )}
    ...
    <p>
      ...
      <a
        target="_blank"
        rel="noopener noreferrer"
        href="https://www.facebook.com/LEGO/photos/a.10150175674793403/10159209917393403/"
      >
        Here’s a good example of post from Lego that keeps emojis at the end and
        when needed.
      </a>
      <SocialMediaExample img={FacebookGE} />
    </p>
    {answer === "no" ? (
      <p>
        If you want to learn more,{" "}
        ...
        goes in further details on what to avoid in copy and formatting.
        Additionally,{" "}
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://uxdesign.cc/just-not-my-type-bb33eb8183c7"
        >
          Alexa Heinrich explains{" "}
        </a>
        why using fancy fonts on social media is bad idea.
      </p>
    ) : null}
  </>
);
  ...
  <>
    <p>
      ...
      <a
        target="_blank"
        rel="noopener noreferrer"
        href="https://twitter.com/HashtagHeyAlexa/status/1318655972521529347?s=20&t=IsbTtcGBr7P8xOhm-cDzxQ"
      >
